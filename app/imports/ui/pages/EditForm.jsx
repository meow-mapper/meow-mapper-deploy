...
const bridge = new SimpleSchema2Bridge(Persons.schema);
  ...
  renderPage() {
    return (
      <Grid container centered>
        <Grid.Column>
          <Header as="h2" textAlign="center" inverted>Edit Requests</Header>
...
export default withTracker(({ match }) => {
  ...
  // Get the document
  const doc = Persons.collection.findOne(documentId);
  return {
    doc,
    ready,
  };
